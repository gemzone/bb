...
//	public List<Post> getPosts(int boardId, int page, int size)
//	{
//		if (page <= 0) { page = 1; }
//		if (size <= 0) { size = 15; }
//		
...
//		{
//			@SuppressWarnings({ "rawtypes" })
//			Query query = session.createQuery("from Post  as p left join fetch p.user where p.boardId = " + boardId);
...
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
//			post = (Post) session.get("Post", postId);
//		}
//		catch(Exception e)
//		{
...
//	 * @return
//	 */
//	public Post getNextPost(int boardId, long postId)
//	{
//		Post post = null;
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
...
//	 * @return
//	 */
//	public Post getPrevPost(int boardId, long postId)
//	{
//		Post post = null;
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
...
//	}
//	
//	public Long getPostsTotalCount(int boardId) 
//	{
//		Long count = 0L;
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
//			count = (Long) session
//					.createQuery("select count(p.postId) from Post p where boardId = " + boardId)
//					.getSingleResult();
//		}
//		catch(Exception e)
//		{
...
//			comments = session.createQuery("from Comment as c "  
...
//	
//	
//	public void setPostIncreaseViewCount(Long postId, int count) 
//	{
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
//			Transaction tx = session.beginTransaction();
//			String sql = "UPDATE gz_post SET hit_count += :count WHERE post_id = :post_id";
//			@SuppressWarnings("rawtypes")
...
//	
//
//	public void setPostIncreaseUpCount(Long postId, int count) 
//	{
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
//			Transaction tx = session.beginTransaction();
//			String sql = "UPDATE gz_post SET up_count += :count WHERE post_id = :post_id";
//			@SuppressWarnings("rawtypes")
//			NativeQuery query = session.createNativeQuery(sql);
//			query.setParameter("count", count);
//			query.setParameter("post_id", postId);
...
//	}
//	
//	public void setPostIncreaseCommentCount(Long postId, int count) 
//	{
//		try ( Session session = HibernateUtil.getSessionFactory().openSession() )
//		{
//			Transaction tx = session.beginTransaction();
//			String sql = "UPDATE gz_post SET comment_count += :count WHERE post_id = :post_id";
//			@SuppressWarnings("rawtypes")
//			NativeQuery query = session.createNativeQuery(sql);
//			query.setParameter("count", count);
//			query.setParameter("post_id", postId);
...
//		{
//			Transaction tx = session.beginTransaction();
//			String sql = "INSERT INTO gz_post (board_id, uid, user_id, category_id, notice, secret, title, text, attachment, link, ip) " +
...
//			
//			
//			String sql = "INSERT INTO gz_post_comment "
...
//			
//			@SuppressWarnings("rawtypes")
//			Query query = session.createQuery("delete from Comment where postId=:post_id");
...
//		map.addAttribute("posts", getPosts(board.getBoardId(), page, size) );
//		Long postsTotalCount = getPostsTotalCount(board.getBoardId());
